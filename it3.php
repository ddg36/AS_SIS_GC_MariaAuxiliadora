...
<div class="container">
    <div class="management section-bg">
        <h1>Administrar Especialidades e Informes y Estadísticas</h1>

        <!-- Formulario para administrar especialidades -->
        ...
        <!-- Formulario para generar informes y estadísticas -->
        <form method="post" action="" class="php-form">
            <h2>Generar Informes y Estadísticas</h2>
            <div class="form-group">
